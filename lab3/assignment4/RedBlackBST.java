...
package com.company; // altered to work with project directory
...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    ***************************************************************************/
        // commented out to remove dependency on StdOut
    ...
    // added to work without other files
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < words; i++) {    // saves the first input *100
        ...
        String max = "";
        st.put(max, 0);
        for(String s : st.keys()) {     // iterates through st finding the highest value
